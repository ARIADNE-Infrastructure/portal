...
class Timeline {
      ...
      'bool' => [
        'must' => [
          [
            'range' => [
              'temporal.until' => [
                'gte' => "".$rangeStartYear // type conversion for es to work properly
              ]
            ]
          ],
          [
            'range' => [
              'temporal.from' => [
                'lte' => "".$rangeEndYear // type conversion for es to work properly
              ]
            ]
          ]
        ]
  ...
  /**
   * Get all resources where 'from' AND 'until' is INSIDE range
   *
   * @param $range start,stop comma separated
   * @return array
   */
